...
public class Page  
{
   ...
   public static final java.util.ArrayList<Object> EMPTY_content = new java.util.ArrayList<Object>()
   { @Override public boolean add(Object value){ throw new UnsupportedOperationException("No direct add! Use xy.withContent(obj)"); }};

   public static final String PROPERTY_content = "content";

   private java.util.ArrayList<Object> content = null;

   public java.util.ArrayList<Object> getContent()
   {
   ...
   public Page withoutContent(Object... value)
   {
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof Object)
         {
            if (this.content.contains(item))
            {
               this.content.remove((Object)item);
